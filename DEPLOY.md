...
> ⚠️ Use the branch **`arena/01a04e9a-mc-bot-manager`** — it contains the
> deploy fixes. (`main` is outdated.)
...
4. Wait for the build (first build ~3–5 min). Then:
